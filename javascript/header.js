...
function headerProjects () {
    ...
    function btnHeader() {
        ...
        if(document.querySelector('.header-main').classList.contains('open-header')){
            headerPage.style.margin = '70px auto auto';
        } else {
            headerPage.style.margin = '0px';
        }
    }
    window.addEventListener('resize', () => {
        if(window.innerWidth > 850) {
            document.querySelector('.header-page').style.margin = '70px auto auto';
        } else {
            document.querySelector('.header-page').style.margin = '0px';
        }
    });
}
function headerBack () {
...
} else if (document.title === 'Ecommerce' || document.title === 'Snake Game' || document.title === 'Curso de JAVASCRIPT desde CERO - Nivel MASTER' || document.title === 'FreeCodeCamp'){
